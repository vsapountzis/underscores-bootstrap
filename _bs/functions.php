...
if ( ! function_exists( '_bs_setup' ) ) :
	...
	function _bs_setup() {
		 ...
		 * If you're building a theme based on _bs, use a find and replace
		 * to change '_bs' to the name of your theme in all the template files.
		 */
...
function _bs_content_width() {
	$GLOBALS['content_width'] = apply_filters( '_bs_content_width', 640 );
}
...
function _bs_scripts() {
	wp_enqueue_style( '_bs-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_enqueue_script( '_bs-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
